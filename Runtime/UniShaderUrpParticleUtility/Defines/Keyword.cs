...
namespace UniUrpParticleShader
{
    ...
    public class Keyword
    {
        ...
        /// <summary>Metallic Specular Gloss Map</summary>
        ...
        /// <summary>Flip Book Blending On</summary>
        public const string FlipBookBlendingOn = "_FLIPBOOKBLENDING_ON";

        /// <summary>Soft Particles On</summary>
        public const string SoftParticlesOn = "_SOFTPARTICLES_ON";
